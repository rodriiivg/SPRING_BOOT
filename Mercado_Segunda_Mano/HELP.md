...
**Necesario crear un contenedor Redis en Docker y ejecutarlo**
...
* [Spring Data Reactive Redis](https://docs.spring.io/spring-boot/docs/3.1.0-SNAPSHOT/reference/htmlsingle/#data.nosql.redis)
